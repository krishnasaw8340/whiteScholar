import { AspectRatio, Box, Button, Flex, GridItem, Heading, Image, LinkBox, LinkOverlay, SimpleGrid, Stack, Text } from '@chakra-ui/react'
...
const Home = () => {
    return (
        <Box>
            <Box p={4 * 8} pr={8} pl={24}>
                <SimpleGrid columns={{ base: 1, md: 2 }}>
                    <Flex direction='column' alignItems='flex-start' spacing={4}>
                        ...
                        >
                            Resume, jobs, Study-Notes <Box as='span' color='blue.500' fontWeight='bold'>100+ </Box>Useful Websites and much more....
                        </Text>
                        <Heading mb={4}>
                        ...
                        <Text mb={4} fontSize='lg'>
                            ...
                            <Box as='span'> provides you to Build Resume,  Find a Jobs, Useful Websites, Hand-written</Box>
                            <Box as='span'> notes and cheatsheets. Your are just  <br/> one step away to Explore </Box>
                            this community. Let's make this community.
                            <Box as='span' color='blue.500' fontWeight='bold'> AWESOME!</Box>
                        </Text>
                        <Flex mt={6}>
                            <a href='#explore'> <Button colorScheme='blue' mr={4} >  Explore Now</Button> </a>
            ...
            <Box m="0 5% 0 5%" border="4px solid " borderColor="blue.500" borderRadius="10px">
                <Text id="head">Our Services</Text>
                <SimpleGrid columns={{ base: 1, sm: 2, md: 2, lg: 3 }} >

                    {list.map((item, idx) => (
                        <Box m="0 22% 0 22%" pl="3%" id="text1"
                            borderRadius={4}
                            ...
                            <Text id='text2' color="blue.700">{item.title}</Text>
                            <Text id='text3'>{item.des}
                            </Text>
                        </Box>
                    ))}
                </SimpleGrid>
                        ...
                        <GridItem p={4} mx={{ base: 6, sm: 1 }}>
                            <LinkBox
                                ...
                                <Box  w="100%" h="100%" align="center" p="10px">
                                    <Box w="26%" h="50px" borderRadius="300px" color="white" bgColor="blue.500">
                                    ...
                                    <Text textColor="black" fontFamily="cursive">{social.des}</Text>
                                </Box>
                            </LinkBox>
                        </GridItem>
                    ))}
                </SimpleGrid>
                <Flex float="right" fontSize="18px" p="10px 0 10px 0" color="purple.800"><a href="#">Give your Feedback and see yourself in review section....</a></Flex>
            </Box>
            ...
            <Box m="0 8% 0  8%" >
                <Text id="head" mt="10%">Meet Our Teams</Text>
                            ...
                            <LinkBox
                                ...
                                <Box h="100%" w="100%" align="center" >
                                    <Image boxSize='150px'
                                        borderRadius="200px"
                                        objectFit='cover'
                                        alt='Dan Abramov' src={social.profile}></Image>
                                    <Text color="blue.500" fontSize="20px" fontWeight="bold" p="10px 0 10px 0">
                                        {social.position}
                                    </Text>
                                    <Flex justifyContent="center" alignItems="center">
                                        <a href={social.tLink} target="_blank">
                                            <Image h="40px" mr="20px" src={social.t} ></Image>
                                        </a>
                                        <a href={social.lLink} target="_blank">
            ...
            <Box m="0 8% 10% 8%" >
                <Text id="head" mt="10%">Join Our NewsLetter</Text>
                <Text textAlign="center" fontSize="17px">Never miss any new content, hacks get them right onto your device</Text>
            ...
            <Box id="footer"
                ...
                h="7vh" ml="3%" borderRadius="80px 0 0 0">
                <Flex justifyContent="space-around" alignItems="center">
                    <Text color="whiteAlpha.700" _hover={{ color: 'blue.100', fontSize: 'xl' }} fontSize="18px" ml="5%"><a href="https://twitter.com/Krissna01" target="_blank">Admin</a></Text>
                    {/* <Text color="whiteAlpha.900" fontSize="20px" ml="5%">Copyright @2022 whiteScholar</Text> */}
                    <Box color="whiteAlpha.900" fontSize="18px" textAlign="center">Copyright @2022 whiteScholar</Box>
                    <Box color="whiteAlpha.900" fontSize="18px" ml="5%">All Rights Reserved</Box>
