      ...
      <Box fontFamily={"'Ubuntu', sans-serif;'"}>
        ...
        >
          ...
          <DrawerContent>
            ...
            <Box fontFamily={"'Ubuntu', sans-serif;'"} id="howCss">How it works?</Box>
            <Flex><Button onClick={works} m="0 20px 0 10px" colorScheme='green' >Show</Button>
            
              
              <Button onClick={works2} colorScheme='red' >close</Button>
              {content ? null : null}
            </Flex>
...
const Content = () => <Box border="2px solid" borderColor="blue.500" p="30px" fontSize="18px" fontFamily={"'Ubuntu', sans-serif;'"} h="40vh" w="100%" >
  ...
  <Text>Your content will be reviewed and added to the app, also see yourself in contributors.</Text>
